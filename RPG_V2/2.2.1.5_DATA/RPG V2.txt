...
'Date: 06/10/2014 (DD/MM/YYYY)						DD = Day		MM = Month		YYYY = Year
'Time: 13:31 PM  (HH/MM/PM;AM)						HH = Hours		MM = Minutes	PM;AM = PM Or AM
'Game Version: 2.2.1.5
'Game Version Meaning:
'-----------------------
'Alpha(1)/Beta(2)/Gamma(3)/Snapshot(0)      Update #         Update/New Stuff          Latest Bug Fix Update
'0			              					.    0		     .    0					   .    0
'-----------------------	
'Values:
MainMenu1=0
