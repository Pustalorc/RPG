...
Function Heal2
	SelectPotion=inputbox("Which Potion Do You Want To Use? (SPotion, MPotion, BPotion, SSPotion)")
...
Function RandomChestReward
	...
	If Chance0=1 then
		...
		If Chance1=1 then
			msgbox("You Found The Ultimate Sword With The Ultimate Shield!")
			msgbox("You Also Found $100 K!")
			Sword = 999999
			Damage = 99999999
			Shield = 999999
...
Do While Shoping=1
	Shop=inputbox("$100 Wooden Sword, $100 Wooden Shield, $25 SPotion, $40 MPotion, $70 BPotion, $200 Stone Sword, $225 Stone Shield, $400 Metal Sword, $450 Metal Shield, $800 Golden Sword, $900 Golden Shield, $1600 Diamond Sword, $1800 Diamond Shield, $140 SSPotion")
	...
	elseif Shop="SPotion" then
		...
		elseif Money>=25 then
			PotionsBuying=inputbox("How Many Do You Want To Buy? (MAX 10)")
			If PotionsBuying>=11 then
				msgbox("Exceeds Limit >_>")
			elseif PotionsBuying<="-1" then
				msgbox("Too Low, You Can't Sell Potions!")
			elseif PotionsBuying>=0 And PotionsBuying<=10 then
				MoneyToSpend=25*PotionsBuying
				If Money<MoneyToSpend then
					msgbox("Not Enough Money To Buy All Those Potions!")
				elseif Money>=MoneyToSpend then
					Money=Money-MoneyToSpend
					msgbox("You Bought " & PotionsBuying & " SPotion(s)!")
					SPotion=SPotion+PotionsBuying
					If SPotion>=11 then
						Spotion=10
					End If
	...
	elseif Shop="MPotion" then
		...
		elseif Money>=40 then
			PotionsBuying=inputbox("How Many Do You Want To Buy? (MAX 7)")
			If PotionsBuying>=8 then
				msgbox("Exceeds Limit >_>")
			elseif PotionsBuying<="-1" then
				msgbox("Too Low, You Can't Sell Potions")
			elseif PotionsBuying>=0 And PotionsBuying<=7 then
				MoneyToSpend=40*PotionsBuying
				If Money<MoneyToSpend then
					msgbox("Not Enough Money To Buy All Those Potions!")
				elseif Money>=MoneyToSpend then
					Money=Money-MoneyToSpend
					msgbox("You Bought " & PotionsBuying & " MPotion(s)!")
					MPotion=MPotion+PotionsBuying
					If MPotion>=8 then
						MPotion=7
					End If
	...
	elseif Shop="BPotion" then
		...
		elseif Money>=70 then
			PotionsBuying=inputbox("How Many Do You Want To Buy? (MAX 5)")
			If PotionsBuying>=6 then
				msgbox("Exceeds Limit >_>")
			elseif PotionsBuying<=-1 then
				msgbox("Too Low, You Can't Sell Potions")
			elseif PotionsBuying>=0 And PotionsBuying<=5 then
				MoneyToSpend=70*PotionsBuying
				If Money<MoneyToSpend then
					msgbox("Not Enough Money To Buy All Those Potions!")
				elseif Money>=MoneyToSpend then
					Money=Money-MoneyToSpend
					msgbox("You Bought " & PotionsBuying & " BPotion(s)!")
					BPotion=BPotion+PotionsBuying
					If BPotion>=6 then
						BPotion=5
					End If
	...
	elseif Shop="SSPotion" then
		...
		elseif Money>=140 then
			...
			elseif PotionsBuying<=-1 then
				msgbox("Too Low, You Can't Sell Potions")
			elseif PotionsBuying>=0 And PotionsBuying<=5 then
				MoneyToSpend=140*PotionsBuying
				If Money<MoneyToSpend then
					msgbox("Not Enough Money To Buy All Those Potions!")
				elseif Money>=MoneyToSpend then
					Money=Money-MoneyToSpend
					msgbox("You Bought " & PotionsBuying & " SSPotion(s)!")
					SSPotion=SSPotion+PotionsBuying
					If SSPotion>=6 then
						SSPotion=5
					End If
...
Do While AdventureMode=1
	ChoosingDungeon=inputbox("Where Do You Want To Go? (1. Forest    2. Volcano    3. Castle    4. Desert    5. Sea    6. Beach    7. Hut	8. Level Up Area   9. End Game	10. Quests	11. ULTIMATE DUNGEON)")
	...
	elseif ChoosingDungeon="ULTIMATE DUNGEON" then
		if Level<11 then
			msgbox("You Are Not High Level Enough To Go Here! You Need To Be Level 11!")
...
Do While UltimateDungeon=1
	...
	EnemyHealth = 500000000
	EnemyDamage = 250000000
	...
	sword=9999999
	Damage=999999999
	x=msgbox("This sword I gave you does 999.999 Million damage, use it well. I have to die now... You can choose to chop my head off if you want or not.", ,"M A X I M E (Ultimate Boss)")
